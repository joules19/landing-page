export default {
  ...
  colors: {
    ...
    primary: '#3B65A1', // primary button and link color
  ...
  section: {
    ...
    testimonial: {
      pt: [2, null, 7, '50px', null, 6, null, '130px'],
    ...
    pricing: {
      pt: [9, null, 10, null, null, 10, null, '180'],
  ...
  buttons: {
    ...
    primary: {
      ...
      bg: 'primary',
      '&:hover': {
        boxShadow: 'rgba(10,63,137, 0.57) 0px 9px 20px -5px',
      },
    },
    whiteButton: {
      variant: 'buttons.defaultBtn',
